...
import com.example.smartcommunityapplication.entities.LogUtil;
...
//        LogUtil.i("drawFilmScreen = " + centerX + "---" + getMatrixTranslateY() + "***" + getMatrixTranslateX());
    ...
    private void drawFilmScreen2(Canvas canvas) {
        ...
        path1.close();
        canvas.drawPath(path1, screenPaint);
        canvas.drawText("车库入口", (centerX - filmScreenHeight / 4), transformOldCoordY(filmScreenHeight / 4), textPaint);
    }
