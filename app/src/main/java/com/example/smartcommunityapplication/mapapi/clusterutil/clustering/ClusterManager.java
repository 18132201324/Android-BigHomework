package com.example.smartcommunityapplication.mapapi.clusterutil.clustering;/*
...
import com.example.smartcommunityapplication.mapapi.clusterutil.clustering.algo.Algorithm;
import com.example.smartcommunityapplication.mapapi.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.example.smartcommunityapplication.mapapi.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import com.example.smartcommunityapplication.mapapi.clusterutil.clustering.view.ClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public ClusterManager(Context context, BaiduMap map, MarkerManager markerManager) {
        ...
        //mRenderer = new ClusterRenderer<T>(context, map, this);
